  ...
  <div>
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.25rem;">
      ...
      <div style="display: flex; gap: 0.625rem; align-items: center;">
        ...
        <a :href="`/api/reports/dashboard?format=pdf&filterType=${filterType}&month=${filterDate.split('-')[1]}&year=${filterDate.split('-')[0]}`" target="_blank">
          <button class="btn" style="background: #c62828; font-size: 1rem;">Export PDF</button>
        </a>
        <a :href="`/api/reports/dashboard?format=excel&filterType=${filterType}&month=${filterDate.split('-')[1]}&year=${filterDate.split('-')[0]}`" target="_blank">
          <button class="btn" style="background: #107c41; font-size: 1rem;">Export Excel</button>
        </a>
        <a :href="`/api/reports/dashboard?format=word&filterType=${filterType}&month=${filterDate.split('-')[1]}&year=${filterDate.split('-')[0]}`" target="_blank">
