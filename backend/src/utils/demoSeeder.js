...
const generateAdvancedSeed = async () => {
    ...
    // 1. Rooms
    const rooms = [
        { tipeKamar: 'Room Elegan', fasilitas: 'Emas', price: 250000, totalStock: 10, availableStock: 6, cleaningStock: 2, maintenanceStock: 2, conditions: { 'Sangat Baik': 8, 'Baik': 2, 'Rusak Ringan': 0 }, imageUrl: '/uploads/demo_emas.png' },
        { tipeKamar: 'Room Modern', fasilitas: 'Silver', price: 300000, totalStock: 5, availableStock: 4, cleaningStock: 1, maintenanceStock: 0, conditions: { 'Sangat Baik': 4, 'Baik': 1, 'Rusak Ringan': 0 }, imageUrl: '/uploads/demo_silver.png' },
        { tipeKamar: 'Room Klasik', fasilitas: 'Merah', price: 200000, totalStock: 15, availableStock: 12, cleaningStock: 2, maintenanceStock: 1, conditions: { 'Sangat Baik': 10, 'Baik': 3, 'Rusak Ringan': 2 }, imageUrl: '/uploads/demo_merah.png' },
    ...
    const insertedCustomers = await Customer_1.default.insertMany(customers);
    ...
    for (let i = 0; i < 40; i++) {
        ...
        if (cRand < 0.35)
            ...
            cIndex = i % 2 === 0 ? 6 : 7; // Minimal usage for completely empty customers
    ...
    await RentalTransaction_1.default.insertMany(rentals);
    console.log('Advanced Demo Data Successfully Seeded!');
};
exports.generateAdvancedSeed = generateAdvancedSeed;
//# sourceMappingURL=demoSeeder.js.map